    ...
    return (
        <div className={twMerge('relative', className)}>
            <input
                ...
                className="focus-visible:ring-primary ring-offset-secondary-1 bg-secondary-2/20 outline-primary/40  hover:outline-primary/60 h-9 w-full rounded-md px-3 text-sm font-medium text-white outline outline-1 transition-colors placeholder:font-light focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50"
                value={value}
